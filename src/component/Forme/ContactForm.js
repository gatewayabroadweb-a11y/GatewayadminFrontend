...
function ContactForm() {
  const type = 'contact';
  const { data, loading, error, run } = useAsync(PageServices.getFormData);
      ...
      <section className="content">
        ...
        <div className="card">
          <div className="card-header">
            <h3 className="card-title">Contact us Form</h3>
                ...
                {form.map((contact, index) => (
                  <tr key={index}>
                    ...
                    <td className="project-actions text-right">
                      <Link className="btn btn-primary btn-sm mr-2" to={`/admin/view-contact-form/${contact._id}`}>
